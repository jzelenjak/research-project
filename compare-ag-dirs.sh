...
echo "Total number of AGs generated the original algorithm: $(echo -e "$original_ags" | wc -l)"
echo "Total number of AGs generated the modified algorithm: $(echo -e "$modified_ags" | wc -l)"
